...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'ONC Certification (g)(33) Standardized API Test Kit'
  spec.description   = 'ONC Certification (g)(33) Standardized API Test Kit'
  spec.homepage      = 'https://github.com/onc-healthit/onc-certification-g33-test-kit'
  spec.license       = 'Apache-2.0'
  spec.add_dependency 'davinci_pas_test_kit', '~> 0.15', '>= 0.15.1'
